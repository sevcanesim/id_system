...
const login=read('app/giris/page.tsx')+read('app/giris/LoginClient.tsx'); const header=read('app/components/AppHeader.tsx'); const account=read('app/hesabim/page.tsx');
pass('individual login no longer defaults through /hesabim',login.includes('"/kartlarim"')&&!login.includes('useState("/hesabim")'));
