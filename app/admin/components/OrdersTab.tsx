...
export default function OrdersTab({
  ...
  return <>
    ...
    {visible.length === 0 ? <EmptyState compact icon="search" title="Bu filtrelerde satış bulunmuyor" description="Filtreleri genişleterek veya arama ifadesini değiştirerek tekrar dene." /> : <div className={styles.tableWrap}><table className={styles.table}><thead><tr><th>Sipariş</th><th>Müşteri / şirket</th><th>Ürün</th><th>Tutar</th><th>Ödeme</th><th>Hesap</th><th>Fulfillment</th><th>Son işlem</th><th></th></tr></thead><tbody>{visible.map((order) => {
