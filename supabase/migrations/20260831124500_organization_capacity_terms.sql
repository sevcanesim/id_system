...
begin
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'organization_capacity_terms'
      and policyname = 'organization_capacity_terms_member_read'
  ) then
...
comment on table public.organization_capacity_terms is
  'Independent corporate card-capacity renewal terms. Each paid capacity purchase keeps its own start, expiry and renewal price.';
