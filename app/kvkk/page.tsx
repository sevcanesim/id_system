  ...
  return (
    <main id="main-content" className="legal-page legal-page--premium">
      ...
      <div className="legal-shell">
        ...
        <section id="veri-sorumlusu"><h2>1. Veri Sorumlusu</h2><p>6698 sayılı Kişisel Verilerin Korunması Kanunu kapsamında veri sorumlusu, Yenomi ID markasını işleten <strong>{legal.tradeName}</strong> şirketidir.</p><table><tbody><tr><th>Unvan</th><td>{legal.tradeName}</td></tr><tr><th>MERSİS</th><td>{legal.mersisNumber}</td></tr><tr><th>Vergi dairesi / no</th><td>{legal.taxOffice} / {legal.taxNumber}</td></tr><tr><th>Adres</th><td>{legal.address}</td></tr><tr><th>E-posta</th><td>{legal.kvkkEmail}</td></tr></tbody></table></section>
