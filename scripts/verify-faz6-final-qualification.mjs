...
quality.includes('npm run test:visual') ? pass('quality workflow retains visual regression gate') : fail('quality workflow retains visual regression gate');
...
staging.includes('npm run test:visual') ? pass('staging workflow retains authenticated visual gate') : fail('staging workflow retains authenticated visual gate');
