...
check(dashboard.includes('spareEntitlementCount') || dashboard.includes('spare'), 'entitlement capability gate retained internally');
...
check(pkg.version.startsWith('25.'), 'package version retains Phase 8.1 cleanup or later');
