...
const cardsPanel = fs.readFileSync('app/kurumsal/panel/components/CardsPanel.tsx','utf8');
const checks = [
  ...
  ['cards page uses physicalCardLabel', /data-status=\{card\.status\}>\{physicalCardLabel\(card\.status\)\}/.test(cardsPanel)],
