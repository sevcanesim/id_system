...
export default function ReconciliationTab({
  ...
  resolutionNotes, setResolutionNotes, resolvingIssue, retrievingOrderId,
  onReload, onRunPaidReconciliation, onRetrieveIyzico, onResolveIssue,
}: {
  ...
  retrievingOrderId: string | null;
  onReload: () => void;
  onRunPaidReconciliation: () => void;
  onRetrieveIyzico: (orderId: string) => void;
