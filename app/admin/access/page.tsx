  ...
  return <main className={styles.page} id="main-content">
    <section className={styles.shell}>
      ...
      <section className={styles.note}>
        ...
        <p>1) Yeni kullanıcı hesabı oluşturulur. 2) Buradan Super Admin yetkisi verilir. 3) Yeni yönetici kendi hesabıyla giriş yapar ve kendi Google Authenticator faktörünü kurar. 4) Satış ve Operasyon ekranları yeni hesapla test edilir. 5) Eski yöneticinin yetkisi kaldırılır.</p>
        <div className={styles.links}>
          <Link href="/admin/security">Google Authenticator / Güvenlik</Link>
          <Link href="/admin/devir-rehberi">Tam devir rehberini aç</Link>
          <Link href="/admin/operations">Operasyon ekranını test et</Link>
        </div>
      </section>
    </section>
  </main>;
