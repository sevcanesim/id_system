...
export default function AnalyticsPage(){
  ...
  return <UserPanelShell activeKey="analytics" eyebrow="KART" title="İstatistikler" description="Dijital profilinizin gerçek görüntülenme verisini sade ve anlamlı metriklerle takip edin.">
    {loading?<Card><p className="p9-section-copy">İstatistikler yükleniyor…</p></Card>:!data?<EmptyState title="İstatistikler yüklenemedi." description="Oturumunuzu kontrol edip yeniden deneyin." action={{ href: "/giris?next=%2Fistatistikler", label: "Hesabına gir" }} />:data.totalViews===0 && data.last30DaysViews===0?<EmptyState title="Henüz görüntülenme yok." description="Kartınızı paylaştığınızda görüntülenme ve etkileşim verileri burada oluşur." action={<Link className="ds-button ds-button--primary" href="/kartim">Kartımı Aç</Link>} />:<div className="p9-stack">
